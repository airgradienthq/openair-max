...
void enableIO()
{
  ...
  gpio_hold_dis(IO_WDT);
  gpio_set_direction(IO_WDT, GPIO_MODE_OUTPUT);
  gpio_set_pull_mode(IO_WDT, GPIO_FLOATING);
  gpio_set_level(IO_WDT, 0);
  ...
  gpio_set_pull_mode(EN_CE_CARD, GPIO_FLOATING);
